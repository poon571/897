...
export default function GamePage() {
  ...
  return (
    <>
        ...
        <div id="ui-layer">
          ...
          <div id="modal-save-slots" className="modal-backdrop hidden" style={{ zIndex: 550 }}>
            <div className="retro-window save-slots-window">
              ...
              <div id="save-slots-account-badge" style={{ textAlign: "center", fontSize: "13px", margin: "-4px 0 12px 0", color: "#94a3b8" }}></div>
          ...
          {/* MODAL: CONFIRM DELETE SAVE SLOT */}
          <div id="modal-confirm-delete-slot" className="modal-backdrop hidden" style={{ zIndex: 600 }}>
            <div className="retro-window confirm-delete-window">
              <div className="window-header-ribbon header-ribbon-danger" style={{ position: "relative", width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", boxSizing: "border-box" }}>
                <span className="ribbon-text">⚠️ ยืนยันการลบข้อมูล (DELETE SAVE SLOT)</span>
                <button id="btn-close-confirm-delete-x" className="retro-btn-close" title="ยกเลิก">✕</button>
              </div>

              <div className="confirm-delete-body">
                <div className="confirm-delete-icon-wrapper">
                  <div className="confirm-delete-icon">🗑️</div>
                  <div className="confirm-delete-pulse"></div>
                </div>

                <h3 className="confirm-delete-title">
                  คุณต้องการลบข้อมูลช่องเซฟนี้หรือไม่?
                </h3>

                <div id="confirm-delete-slot-name" className="confirm-delete-slot-card">
                ...
                <div className="confirm-delete-warning-box">
                  ...
                  <div className="warning-text">
                    ข้อมูลการผจญภัย เลเวล ไอเทม และความคืบหน้าทั้งหมด<br />
                    ในช่องเซฟนี้จะ<strong>สูญหายถาวร</strong> และไม่สามารถกู้คืนได้!
                  </div>
                </div>

                <div className="confirm-delete-actions">
                  <button id="btn-confirm-delete-cancel" className="retro-btn-secondary btn-delete-cancel">
                    ❌ ยกเลิก
                  </button>
                  <button id="btn-confirm-delete-execute" className="retro-btn btn-delete-danger">
                    🗑️ ยืนยันการลบข้อมูล
                  </button>
                </div>
              </div>
          ...
          <div id="modal-settings" className="modal-backdrop hidden">
            <div className="retro-window settings-window">
              ...
              {/* ACCESSIBILITY & FONT SCALE SECTION */}
              <div className="settings-section">
                <div className="settings-section-title">
                  <span>🔤</span> ขนาดตัวอักษรและการนำเสนอ (Text Size & Accessibility)
                </div>

                <div className="settings-row">
                  <div className="settings-label-group">
                    <div className="settings-label">ขนาดตัวอักษรในเกม (Font Scale)</div>
                    <div className="settings-desc">ปรับขนาดตัวอักษรให้อ่านง่ายขึ้น เหมาะสำหรับการฉายโปรเจกเตอร์</div>
                  </div>
                  <div className="settings-control-group">
                    <div className="settings-btn-group" id="group-font-scale">
                      <button type="button" className="settings-btn-choice active" data-scale="normal">ปกติ (100%)</button>
                      <button type="button" className="settings-btn-choice" data-scale="large">ใหญ่ (120%)</button>
                      <button type="button" className="settings-btn-choice" data-scale="xlarge">ใหญ่พิเศษ (138%)</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* MODAL: MINIGAME 7 — HERBAL BIO-EXTRACT LAB (Zone 4) */}
          <div id="modal-minigame-herbal" className="modal-backdrop hidden">
            <div className="retro-window minigame-window-lg">
              <div className="window-header-ribbon">
                <span className="ribbon-text">
                  🌿 ห้องทดลอง : สกัดและจับคู่สมุนไพรอารักขาพืช
                </span>
                <button id="btn-close-herbal-x" className="retro-btn-close" title="ออกจากมินิเกม">✕</button>
              </div>
              <p style={{ fontSize: "14px", marginBottom: "8px" }}>
                เลือก<b style={{ color: "var(--gold-highlight)" }}>สมุนไพรด้านบน</b> แล้วนำไปคลิกใส่<b style={{ color: "var(--hp-green)" }}>ช่องศัตรูพืชเป้าหมายด้านล่าง</b> ให้ถูกต้องครบทั้ง 4 ชนิด!
              </p>
              <div className="minigame-box herbal-lab-container">
                <div className="herbal-slots-grid">
                  <div className="herbal-card-btn" data-herb="neem" id="herb-card-neem">
                    <span className="herbal-card-icon">🌿</span>
                    <div>
                      <div className="herbal-card-title">สะเดา (Neem)</div>
                      <div className="herbal-card-desc">สาร Azadirachtin ยับยั้งการลอกคราบ</div>
                    </div>
                  </div>
                  <div className="herbal-card-btn" data-herb="citronella" id="herb-card-citronella">
                    <span className="herbal-card-icon">🌾</span>
                    <div>
                      <div className="herbal-card-title">ตะไคร้หอม (Citronella)</div>
                      <div className="herbal-card-desc">น้ำมันหอมระเหยกลิ่นฉุนขับไล่แมลงบิน</div>
                    </div>
                  </div>
                  <div className="herbal-card-btn" data-herb="galangal" id="herb-card-galangal">
                    <span className="herbal-card-icon">🥔</span>
                    <div>
                      <div className="herbal-card-title">ข่า & ขมิ้นชัน (Turmeric)</div>
                      <div className="herbal-card-desc">สารเคอร์คูมินต้านเชื้อราใบจุดใบไหม้</div>
                    </div>
                  </div>
                  <div className="herbal-card-btn" data-herb="marigold" id="herb-card-marigold">
                    <span className="herbal-card-icon">🌼</span>
                    <div>
                      <div className="herbal-card-title">ดาวเรือง (Marigold)</div>
                      <div className="herbal-card-desc">สารที่รากกำจัดไส้เดือนฝอยรากปม</div>
                    </div>
                  </div>
                </div>

                <div style={{ fontSize: "12px", color: "#94a3b8", fontWeight: "bold", textAlign: "left", marginTop: "4px" }}>
                  🎯 ศัตรูพืชในแปลงที่ต้องการแก้ไข:
                </div>

                <div className="herbal-targets-grid">
                  <div className="herbal-target-slot" data-target="caterpillar" id="target-slot-caterpillar">
                    <span style={{ fontSize: "12px", fontWeight: "bold", color: "#f87171" }}>🐛 หนอนกัดกินใบ & เพลี้ยไฟ</span>
                    <span className="herbal-slot-assigned" id="assigned-caterpillar" style={{ fontSize: "11px", color: "var(--hp-green)", marginTop: "2px" }}>[ยังไม่ได้เลือกสมุนไพร]</span>
                  </div>
                  <div className="herbal-target-slot" data-target="mosquito" id="target-slot-mosquito">
                    <span style={{ fontSize: "12px", fontWeight: "bold", color: "#fbbf24" }}>🦟 ยุงและแมลงหวี่ขาวตอมใบ</span>
                    <span className="herbal-slot-assigned" id="assigned-mosquito" style={{ fontSize: "11px", color: "var(--hp-green)", marginTop: "2px" }}>[ยังไม่ได้เลือกสมุนไพร]</span>
                  </div>
                  <div className="herbal-target-slot" data-target="fungus" id="target-slot-fungus">
                    <span style={{ fontSize: "12px", fontWeight: "bold", color: "#c084fc" }}>🍄 โรคเชื้อราและแผลใบไหม้</span>
                    <span className="herbal-slot-assigned" id="assigned-fungus" style={{ fontSize: "11px", color: "var(--hp-green)", marginTop: "2px" }}>[ยังไม่ได้เลือกสมุนไพร]</span>
                  </div>
                  <div className="herbal-target-slot" data-target="nematode" id="target-slot-nematode">
                    <span style={{ fontSize: "12px", fontWeight: "bold", color: "#60a5fa" }}>🪱 ไส้เดือนฝอยรากปมใต้ดิน</span>
                    <span className="herbal-slot-assigned" id="assigned-nematode" style={{ fontSize: "11px", color: "var(--hp-green)", marginTop: "2px" }}>[ยังไม่ได้เลือกสมุนไพร]</span>
                  </div>
                </div>
              </div>
              <div style={{ display: "flex", gap: "10px", marginTop: "12px", width: "100%" }}>
                <button id="btn-exit-herbal" className="retro-btn-secondary" style={{ flex: "0 0 160px" }}>
                  🚪 ออกจากมินิเกม
                </button>
                <button id="btn-submit-herbal" className="retro-btn-action" style={{ flex: 1, marginTop: 0 }}>
                  ✨ สกัดและใช้งานสมุนไพร
                </button>
              </div>
            </div>
          </div>

          {/* MODAL: MINIGAME 8 — SKY RICE TERRACES WATER DAM (Zone 9) */}
          <div id="modal-minigame-terraces" className="modal-backdrop hidden">
            <div className="retro-window minigame-window-lg">
              <div className="window-header-ribbon">
                <span className="ribbon-text">
                  🌊 นาขั้นบันไดเสียดฟ้า : ควบคุมระบบผันน้ำและฝายชะลอน้ำ
                </span>
                <button id="btn-close-terraces-x" className="retro-btn-close" title="ออกจากมินิเกม">✕</button>
              </div>
              <p style={{ fontSize: "14px", marginBottom: "8px" }}>
                ปรับวาล์วระบายน้ำ 3 ระดับคันนาให้อยู่ในสภาวะ <b style={{ color: "var(--hp-green)" }}>"ชะลอน้ำและดักตะกอน (Slow & Store)"</b> เพื่อไม่ให้น้ำหลากพัดหน้าดินพังทลาย!
              </p>
              <div className="minigame-box terraces-flow-container">
                {/* Tier 1 */}
                <div className="terraces-tier">
                  <div className="terraces-tier-info">
                    <span className="terraces-tier-icon">⛰️</span>
                    <div>
                      <div className="terraces-tier-name">ขั้นที่ 1: แปลงยอดดอยรับน้ำฝน</div>
                      <div className="terraces-tier-sub" id="terraces-sub-1">สถานะ: น้ำไหลเชี่ยวจัด เสี่ยงดินถล่ม!</div>
                    </div>
                  </div>
                  <div className="terraces-tier-controls">
                    <button className="terraces-valve-btn" data-tier="1" data-val="fast">ปล่อยเร็ว 80%</button>
                    <button className="terraces-valve-btn active" data-tier="1" data-val="slow">ชะลอน้ำ 30%</button>
                  </div>
                </div>
                ...
                <div className="terraces-tier">
                  <div className="terraces-tier-info">
                    <span className="terraces-tier-icon">🪵</span>
                    <div>
                      <div className="terraces-tier-name">ขั้นที่ 2: ฝายชะลอน้ำดักตะกอนดิน</div>
                      <div className="terraces-tier-sub" id="terraces-sub-2">สถานะ: เปิดประตูดักตะกอนดินอุดมสมบูรณ์</div>
                    </div>
                  </div>
                  <div className="terraces-tier-controls">
                    <button className="terraces-valve-btn active" data-tier="2" data-val="trap">ดักตะกอน 40%</button>
                    <button className="terraces-valve-btn" data-tier="2" data-val="overflow">น้ำล้นท่วม 90%</button>
                  </div>
                </div>
                ...
                <div className="terraces-tier">
                  <div className="terraces-tier-info">
                    <span className="terraces-tier-icon">🌾</span>
                    <div>
                      <div className="terraces-tier-name">ขั้นที่ 3: แปลงรวงข้าวขั้นล่าง</div>
                      <div className="terraces-tier-sub" id="terraces-sub-3">สถานะ: ระดับน้ำขังพอเหมาะ หล่อเลี้ยงต้นข้าว</div>
                    </div>
                  </div>
                  <div className="terraces-tier-controls">
                    <button className="terraces-valve-btn active" data-tier="3" data-val="balance">พอเหมาะ 50%</button>
                    <button className="terraces-valve-btn" data-tier="3" data-val="dry">แห้งขอด 10%</button>
                  </div>
                </div>

                <div className="terraces-waterfall-anim">
                  <div className="terraces-water-bar" id="terraces-stream-bar"></div>
                  <span id="terraces-flow-status" style={{ position: "relative", zIndex: 3, fontSize: "13px", fontWeight: "bold", color: "#fff" }}>
                    💧 ระบบไหลเวียนน้ำ: ชะลอน้ำและดักตะกอนอย่างสมดุล (ปลอดภัย)
                  </span>
                </div>
              </div>
              <div style={{ display: "flex", gap: "10px", marginTop: "12px", width: "100%" }}>
                <button id="btn-exit-terraces" className="retro-btn-secondary" style={{ flex: "0 0 160px" }}>
                  🚪 ออกจากมินิเกม
                </button>
                <button id="btn-submit-terraces" className="retro-btn-action" style={{ flex: 1, marginTop: 0 }}>
                  ✨ ยืนยันการจัดการน้ำ
                </button>
              </div>
            </div>
          ...
          {/* MODAL: MINIGAME 9 — CRYOGENIC SEED VAULT (Zone 10) */}
          <div id="modal-minigame-seedvault" className="modal-backdrop hidden">
            <div className="retro-window minigame-window-lg">
              <div className="window-header-ribbon">
                <span className="ribbon-text">
                  🧬 คลังเมล็ดพันธุ์เวหา : ปรับสภาวะไครโอเจนิกจำศีลเมล็ด
                </span>
                <button id="btn-close-seedvault-x" className="retro-btn-close" title="ออกจากมินิเกม">✕</button>
              </div>
              <p style={{ fontSize: "14px", marginBottom: "8px" }}>
                ปรับอุณหภูมิห้องแช่แข็งให้ได้ <b style={{ color: "#00f5d4" }}>-18°C</b> และปรับความชื้นสัมพัทธ์เมล็ดพันธุ์ให้อยู่ในช่วง <b style={{ color: "#fee440" }}>4% - 6%</b> เพื่อจำศีลเมล็ดพันธุ์ได้นานนับร้อยปี!
              </p>
              <div className="minigame-box seedvault-container">
                <div className="seedvault-chambers">
                  {/* Temp Chamber */}
                  <div className="seedvault-chamber-box">
                    <div className="seedvault-label">❄️ อุณหภูมิห้องเย็น (เป้าหมาย: -18°C)</div>
                    <div className="seedvault-reading" id="seedvault-temp-reading">-5°C</div>
                    <div className="seedvault-buttons">
                      <button className="seedvault-btn" id="btn-temp-down">⬇️ เย็นลง (-)</button>
                      <button className="seedvault-btn" id="btn-temp-up">⬆️ อุ่นขึ้น (+)</button>
                    </div>
                  </div>

                  {/* Moisture Chamber */}
                  <div className="seedvault-chamber-box">
                    <div className="seedvault-label">💧 ความชื้นเมล็ด (เป้าหมาย: 4 - 6%)</div>
                    <div className="seedvault-reading" id="seedvault-moist-reading">12%</div>
                    <div className="seedvault-buttons">
                      <button className="seedvault-btn" id="btn-moist-down">⬇️ ลดความชื้น (-)</button>
                      <button className="seedvault-btn" id="btn-moist-up">⬆️ เพิ่มความชื้น (+)</button>
                    </div>
                  </div>
                </div>

                <div className="seedvault-status-indicator" id="seedvault-status-indicator" style={{ background: "rgba(239, 68, 68, 0.2)", color: "#f87171", border: "1px solid #ef4444" }}>
                  ⚠️ สภาวะปัจจุบัน: อุณหภูมิยังไม่เย็นพอ และเมล็ดมีความชื้นสูงเกินไป เสี่ยงต่อเชื้อรา!
                </div>
              </div>
              <div style={{ display: "flex", gap: "10px", marginTop: "12px", width: "100%" }}>
                <button id="btn-exit-seedvault" className="retro-btn-secondary" style={{ flex: "0 0 160px" }}>
                  🚪 ออกจากมินิเกม
                </button>
                <button id="btn-submit-seedvault" className="retro-btn-action" style={{ flex: 1, marginTop: 0 }}>
                  ✨ ล็อคระบบจำศีลเมล็ดพันธุ์
                </button>
              </div>
            </div>
          </div>

          {/* MODAL: MINIGAME 10 — NPK GOLDEN HARVEST BLENDER (Zone 11) */}
          <div id="modal-minigame-npk" className="modal-backdrop hidden">
            <div className="retro-window minigame-window-lg">
              <div className="window-header-ribbon">
                <span className="ribbon-text">
                  👑 ทุ่งรวงทอง : แท่นปรุงธาตุอาหารพืชทองคำ N-P-K
                </span>
                <button id="btn-close-npk-x" className="retro-btn-close" title="ออกจากมินิเกม">✕</button>
              </div>
              <p style={{ fontSize: "14px", marginBottom: "8px" }}>
                ผสมธาตุอาหารหลัก 3 ชนิดสำหรับระยะติดเมล็ดและออกรวงข้าวสาลีสีทอง: <b style={{ color: "#16a34a" }}>N = 1</b> (ใบพอเหมาะ), <b style={{ color: "#2563eb" }}>P = 2</b> (รากและดอก), <b style={{ color: "#d97706" }}>K = 3</b> (สะสมแป้งเมล็ดเต่ง)!
              </p>
              <div className="minigame-box npk-blender-container">
                <div className="npk-tubes-grid">
                  {/* Nitrogen */}
                  <div className="npk-tube-card">
                    <span className="npk-element-badge badge-n">N</span>
                    <div className="npk-tube-name">ไนโตรเจน (Nitrogen)</div>
                    <div className="npk-tube-role">บำรุงใบและลำต้นเขียว</div>
                    <div className="npk-tube-val" id="npk-val-n">1 ส่วน</div>
                    <div className="npk-btn-group">
                      <button className="npk-btn" id="btn-n-down">-</button>
                      <button className="npk-btn" id="btn-n-up">+</button>
                    </div>
                  </div>

                  {/* Phosphorus */}
                  <div className="npk-tube-card">
                    <span className="npk-element-badge badge-p">P</span>
                    <div className="npk-tube-name">ฟอสฟอรัส (Phosphorus)</div>
                    <div className="npk-tube-role">บำรุงราก การติดดอกออกผล</div>
                    <div className="npk-tube-val" id="npk-val-p">1 ส่วน</div>
                    <div className="npk-btn-group">
                      <button className="npk-btn" id="btn-p-down">-</button>
                      <button className="npk-btn" id="btn-p-up">+</button>
                    </div>
                  </div>

                  {/* Potassium */}
                  <div className="npk-tube-card">
                    <span className="npk-element-badge badge-k">K</span>
                    <div className="npk-tube-name">โพแทสเซียม (Potassium)</div>
                    <div className="npk-tube-role">บำรุงเมล็ดเต่ง สะสมแป้งน้ำตาล</div>
                    <div className="npk-tube-val" id="npk-val-k">1 ส่วน</div>
                    <div className="npk-btn-group">
                      <button className="npk-btn" id="btn-k-down">-</button>
                      <button className="npk-btn" id="btn-k-up">+</button>
                    </div>
                  </div>
                </div>

                <div id="npk-status-display" style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #334e68", padding: "10px", borderRadius: "6px", fontSize: "13px", color: "#cbd5e1" }}>
                  🌾 สูตรปัจจุบัน: <b>1 - 1 - 1</b> (ยังไม่ใช่สูตรเน้นรวงทองคำ K สูงสุด!)
                </div>
              </div>
              <div style={{ display: "flex", gap: "10px", marginTop: "12px", width: "100%" }}>
                <button id="btn-exit-npk" className="retro-btn-secondary" style={{ flex: "0 0 160px" }}>
                  🚪 ออกจากมินิเกม
                </button>
                <button id="btn-submit-npk" className="retro-btn-action" style={{ flex: 1, marginTop: 0 }}>
                  ✨ ผสมธาตุอาหารสู่ทุ่งรวงทอง
                </button>
              </div>
            </div>
          </div>
      ...
      <Script src="/js/main.js?v=1.7.3" strategy="afterInteractive" />
    </>
  );
}
